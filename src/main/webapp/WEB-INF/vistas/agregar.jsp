...
<body>
	...
	<form:form action="/canciones/nueva" method="post" modelAttribute="cancionValida">
           <h1>Agregar cancion</h1>
            <div class="form-group">
                <form:label path="nombre">Nombre</form:label>
                <form:errors class="text-danger" path="nombre"/>
                <form:input placeholder="Cancion" path="nombre"/>
            </div>
              <div class="form-group">
                <form:label path="artista">Artista</form:label>
                <form:errors class="text-danger" path="artista"/>
                <form:input placeholder="Cantante" path="artista"/>
            </div>
            <div class="form-group">
